...
import stratAbi from "../artifacts/contracts/RABT/strategies/Common/StrategyCommonChefLP.sol/StrategyCommonChefLP.json";

const {
  platforms: { pancake, rabbityieldfinance },
  tokens: {
...
const strategyParams = {
  ...
  keeper: rabbityieldfinance.keeper, // Pulled from address book automatically
  rabbityieldFeeRecipient: rabbityieldfinance.rabbityieldFeeRecipient, // Pulled from address book automatically
  rabbityieldFeeConfig: rabbityieldfinance.rabbityieldFeeConfig, // Pulled from address book automatically
  rabbityieldVaultProxy: rabbityieldfinance.vaultFactory, // Pulled from the address book automatically
};
...
async function main() {
  ...
  const strategyConstructorArguments = [
    ...
    [
      ...
      strategyParams.rabbityieldFeeConfig,
    ],
  ];
