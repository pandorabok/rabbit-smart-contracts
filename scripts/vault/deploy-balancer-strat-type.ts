...
import stratAbi from "../../artifacts/contracts/RABT/strategies/Balancer/StrategyBalancerMultiRewardGaugeUniV3.sol/StrategyBalancerMultiRewardGaugeUniV3.json";
import stratComAbi from "../../artifacts/contracts/RABT/strategies/Balancer/StrategyBalancerComposableMultiRewardGaugeUniV3.sol/StrategyBalancerComposableMultiRewardGaugeUniV3.json";

const {
  platforms: { beethovenX, rabbityieldfinance },
  tokens: {
    BAL: { address: BAL },
...
const strategyParams = {
  ...
  rabbityieldFeeConfig: rabbityieldfinance.rabbityieldFeeConfig,
  isBeets: true,
  rabbityieldVaultProxy: "0xA6D3769faC465FC0415e7E9F16dcdC96B83C240B",  //rabbityieldfinance.vaultProxy,
