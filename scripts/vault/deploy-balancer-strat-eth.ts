...
import stratAbi from "../../artifacts/contracts/RABT/strategies/Balancer/StrategyAuraGyroMainnet.sol/StrategyAuraGyroMainnet.json";

const {
  platforms: { balancer, rabbityieldfinance },
  tokens: {
    BAL: { address: BAL },
    ETH: { address: ETH },
    cbETH: { address: cbETH },
...
const strategyParams = {
  ...
  rabbityieldVaultProxy: "0xC551dDCE8e5E657503Cd67A39713c06F2c0d2e97", //rabbityieldfinance.vaultProxy,
