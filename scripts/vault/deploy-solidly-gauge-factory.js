...
import stratAbi from "../../artifacts/contracts/RABT/strategies/Velodrome/StrategyVelodromeFactory.sol/StrategyVelodromeFactory.json";
import { symbolName } from "typescript";

const {
  platforms: { rabbityieldfinance, equalizer },
  tokens: {
    //ETH: { address: ETH },
   // USDCe: { address: USDCe },
    EQUAL: { address: EQUAL },
