...
import stratAbi from "../../artifacts/contracts/RABT/strategies/Gamma/StrategyThenaGamma.sol/StrategyThenaGamma.json";
import stratChefAbi from "../../artifacts/contracts/RABT/strategies/Gamma/StrategyQuickGamma.sol/StrategyQuickGamma.json";


const {
  platforms: { quickswap, rabbityieldfinance },
  tokens: {
    ETH: {address: ETH},
    USDC: {address: USDC},
    MATIC: {address: MATIC},
