...
const params = {
  rabtMaxiVaultAddress: "0xbF07093ccd6adFC3dEB259C557b61E94c1F66945",
  unirouter: spookyswap.router,
  nativeToNativeRoute: [WFTM, RABT],
};
...
const deployStrategistBuyback = async () => {
  ...
  const constructorArguments = [params.rabtMaxiVaultAddress, params.unirouter, params.nativeToNativeRoute];
