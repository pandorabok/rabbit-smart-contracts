...
async function main() {
  ...
  const RabbityieldFeeBatchSimple = await ethers.getContractFactory("RabbityieldFeeBatchSimple");
  const batcher = await RabbityieldFeeBatchSimple.deploy(config.treasury, config.rewardPool, config.wNative);
