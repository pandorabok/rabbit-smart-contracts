...
import RabbityieldOracleAbi from "../../data/abi/RabbityieldOracle.json";
...
const rabbityieldfinanceOracle = rabbityieldfinance.rabbityieldOracle;
...
const uniswapV2Oracle = rabbityieldfinance.rabbityieldOracleUniswapV2;
...
async function setOracle(token, oracle, data) {
  ...
  const oracleContract = await ethers.getContractAt(RabbityieldOracleAbi, rabbityieldfinanceOracle, keeper);
