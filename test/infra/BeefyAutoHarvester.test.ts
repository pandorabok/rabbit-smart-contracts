...
import { RabbityieldHarvester, RabbityieldUniV2Zap, RabbityieldRegistry, IUniswapRouterETH, IWrappedNative, StrategyCommonChefLP, UpkeepRefunder } from "../../typechain-types";
...
describe("RabbityieldHarvester", () => {
  let harvester: RabbityieldHarvester;
  let vaultRegistry: RabbityieldRegistry;
  let zap: RabbityieldUniV2Zap;
