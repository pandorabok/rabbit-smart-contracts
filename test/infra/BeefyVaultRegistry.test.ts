...
import { RabbityieldVaultRegistry } from "../../typechain-types";
...
describe("RabbityieldVaultRegistry", () => {
  let registry: RabbityieldVaultRegistry;
  ...
  beforeEach(async () => {
    ...
    )) as unknown as RabbityieldVaultRegistry;
  });
