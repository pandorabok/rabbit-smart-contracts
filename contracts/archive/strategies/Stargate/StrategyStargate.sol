...
contract StrategyStargate is StratFeeManagerInitializable {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IRabbityieldSwapper(unirouter).swap(output, native, toNative);
    ...
    function addLiquidity() internal {
        uint256 toInput = IERC20(output).balanceOf(address(this));
        IRabbityieldSwapper(unirouter).swap(output, input, toInput);
