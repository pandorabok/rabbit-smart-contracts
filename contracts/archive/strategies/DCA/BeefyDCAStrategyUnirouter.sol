...
contract RabbityieldDCAStrategyUnirouter is Ownable, Pausable {
    ...
    // We send the funds to work in the underlying Rabbityield Vault. 
     ...
     // Withdraw: Converts amount requested from vault to shares and withdraws from Rabbityield Vault, sends the want withdrew to vault. 
