...
import "./RabbityieldERC721Enumerable.sol";

pragma solidity ^0.8.0;
contract RabbityieldDCAVaultBase is RabbityieldERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // Deposit: Will Deposit into rabbityield vault and account for underlying deposited. It will mint a vault if you dont own one by passing through 0 as _id. 
