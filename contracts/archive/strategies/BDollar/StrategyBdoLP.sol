...
contract StrategyBdoLP is Ownable, Pausable {
    ...
    function chargeFees() internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toWbnb, 0, bdoToWbnbRoute, address(this), now.add(600));
    ...
    function addLiquidity() internal {   
        ...
        if (lpToken0 != bdo) {
            IUniswapRouterETH(unirouter).swapExactTokensForTokens(bdoHalf, 0, bdoToLp0Route, address(this), now.add(600));
        }

        if (lpToken1 != bdo) {
            IUniswapRouterETH(unirouter).swapExactTokensForTokens(bdoHalf, 0, bdoToLp1Route, address(this), now.add(600));
        }
