...
contract StrategySbdoLP is Ownable, Pausable {
    ...
    function chargeFees() internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toWbnb, 0, sbdoToWbnbRoute, address(this), now.add(600));
    ...
    function addLiquidity() internal {   
        ...
        if (lpToken0 != sbdo) {
            IUniswapRouterETH(unirouter).swapExactTokensForTokens(sbdoHalf, 0, sbdoToLp0Route, address(this), now.add(600));
        }

        if (lpToken1 != sbdo) {
            IUniswapRouterETH(unirouter).swapExactTokensForTokens(sbdoHalf, 0, sbdoToLp1Route, address(this), now.add(600));
        }
