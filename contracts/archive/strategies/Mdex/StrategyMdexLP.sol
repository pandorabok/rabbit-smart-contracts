...
contract StrategyMdexLP is Ownable, Pausable {
     ...
     * {treasury} - Address of the Rabbityield treasury. Rewards accumulate here and are then sent to BSC.
     ...
     *
     * {TREASURY_FEE} - 3.5% goes to RABT holders through the {treasury}.
