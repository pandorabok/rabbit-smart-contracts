...
contract StrategyHop is StratFeeManagerInitializable {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 rabbityieldFeeAmount = nativeFeeBal * fees.rabbityield / DIVISOR;
    ...
    function _addLiquidity() internal {
        ...
        IRabbityieldSwapper(unirouter).swap(depositToken, want, depositTokenBal);
    }
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256 nativeOut = IRabbityieldSwapper(unirouter).getAmountOut(reward, native, rewardBal);
