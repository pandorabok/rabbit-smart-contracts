 ...
 * @author sirbeefalot & superrabbityieldboy
...
contract StrategyVenusBNB is Ownable, Pausable {
     ...
     * {rabt}  - RabbityieldFinance token, used to send funds to the treasury.
     ...
     * {treasury} - Address of the RabbityieldFinance treasury
     ...
     *
     * {REWARDS_FEE} - 3% goes to RABT holders through the {rewards} pool.
     ...
     * {wbnbToRabtRoute}  - Route we take to go from {wbnb} into {rabt}.
     */
     ...
     * 3. It charges the system fee and sends it to RABT stakers.
    ...
    function _chargeFees() internal {
        ...
        IUniswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToRabtRoute, treasury, now.add(600));
