...
import "../../../archive/strategies/Balancer/RabbityieldBalancerStructs.sol";
...
contract StrategyBalancerMultiRewardChefUniV2 is StratFeeManagerInitializable {
    ...
    function initialize(
        ...
        RabbityieldBalancerStructs.BatchSwapStruct[] calldata _nativeToInputRoute,
        RabbityieldBalancerStructs.BatchSwapStruct[] calldata _outputToNativeRoute,
