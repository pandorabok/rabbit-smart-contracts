...
contract StrategyEsterLP is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        ...
        IUniswapRouter(unirouter).swapExactTokensForTokens(toWftm, 0, outputToWftmRoute, address(this), now);
        ...
        uint256 rabbityieldFeeAmount = wftmBal.mul(rabbityieldFee).div(MAX_FEE);
        IERC20(wftm).safeTransfer(rabbityieldFeeRecipient, rabbityieldFeeAmount);
