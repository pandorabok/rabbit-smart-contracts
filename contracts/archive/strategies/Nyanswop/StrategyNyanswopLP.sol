...
contract StrategyNyanswopLP is Ownable, Pausable {
     ...
     * {wbnbToRabtRoute} - Route we take to get from {usdt} into {rabt}. (pancakeswap)
     ...
     * Sells {nya} to {wbnb} at Nyanswop, buys {rabt} with {wbnb} at Pancakeswap
     * 0.5% -> Call Fee
     * 0.5% -> Treasury fee
     * 0.5% -> Strategist fee
     * 3.0% -> RABT Holders
    ...
    function chargeFees() internal {
        ...
        IUniswapRouter(pancakeswapRouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToRabtRoute, treasury, now.add(600));
