...
contract StrategyMrSushiLP is StratManager, FeeManager {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 rabbityieldFeeAmount = solarNativeBal.mul(rabbityieldFee).div(MAX_FEE);
        IERC20(solarNative).safeTransfer(rabbityieldFeeRecipient, rabbityieldFeeAmount);
