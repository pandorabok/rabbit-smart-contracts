...
contract StrategySatisLP is StratManager, FeeManager, GasThrottler {
    ...
    // Address of the RabbityieldFinance treasury
    ...
    function chargeFees() internal {
        ...
        uint256 rabbityieldFeeAmount = wbnbBal.mul(rabbityieldFee).div(MAX_FEE);
        IERC20(wbnb).safeTransfer(rabbityieldFeeRecipient, rabbityieldFeeAmount);
