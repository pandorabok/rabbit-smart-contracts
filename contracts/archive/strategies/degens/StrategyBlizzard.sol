...
contract StrategyBlizzard is Ownable, Pausable, GasThrottler {
     ...
     * {rewardsFee} - 3.25% goes to RABT holders through the {rewards} pool. Adjusted by callFee changes.
     *
     ...
     * 2. It charges the system fee and sends it to RABT stakers.
    ...
    function chargeFees() internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToRabtRoute, treasury, now.add(600));
