...
/**
 * @dev Interface of a Rabbityield Vault
 */
interface IVault {
...
/**
 * @title Rabbityield Wrapper ERC-4626
 * @author kexley
 * @notice Implementation for an ERC-4626 wrapper of a Rabbityield Vault
 * @dev Wrapped Rabbityield Vault tokens can be minted by deposit of the underlying asset or by 
 * wrapping Rabbityield Vault tokens in a 1:1 ratio. Wrapped Rabbityield Vault tokens can either be unwrapped
 * for an equal number of Rabbityield Vault tokens or redeemed for the underlying asset.
 ...
 */
contract RabbityieldWrapper is ERC4626Upgradeable {
    ...
    /**
     * @notice Initializes an ERC-4626 wrapper for a Rabbityield Vault token
