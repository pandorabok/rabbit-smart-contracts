...
import { IRabbityieldOracle } from "../../interfaces/oracle/IRabbityieldOracle.sol";
import { RabbityieldOracleErrors } from "./RabbityieldOracleErrors.sol";

/// @title Rabbityield Oracle Helper
/// @author Rabbityield, @kexley
/// @notice Helper functions for Rabbityield oracles
library RabbityieldOracleHelper {
    ...
    /// @param _oracle Central Rabbityield oracle which stores the base token price
    ...
    function priceFromBaseToken(
        ...
        (uint256 basePrice,) = IRabbityieldOracle(_oracle).getFreshPrice(_baseToken);
