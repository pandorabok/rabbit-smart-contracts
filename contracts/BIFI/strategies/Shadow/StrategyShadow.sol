...
contract StrategyShadow is BaseAllToNativeFactoryStrat {
    ...
    function _claim() internal override {
        ...
        if (xShadowBalance > 0) {
            ...
            uint256 amountOut = IRabbityieldSwapper(swapper).getAmountOut(x33, shadow, shares);
            ...
            if (amountOut > (xShadowBalance / 2)) {
                ...
                IRabbityieldSwapper(swapper).swap(x33, native, shares);
            } else {
                ...
                IRabbityieldSwapper(swapper).swap(shadow, native, shadowBalance);
            }
        }
    }
