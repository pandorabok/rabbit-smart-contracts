...
const IRewardRegister = require("../artifacts/contracts/RABT/interfaces/binance/IRewardRegister.sol/IRewardRegister.json");
...
const registerSubsidy = async (contract, deployer) => {
  ...
  const appUrl = "https://app.rabbityield.finance/"
