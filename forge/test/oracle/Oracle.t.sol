...
import { IUniswapV2Pair } from "../../../contracts/RABT/interfaces/common/IUniswapV2Pair.sol";
import { IUniswapRouterETH } from "../../../contracts/RABT/interfaces/common/IUniswapRouterETH.sol";
import { RabbityieldOracle } from "../../../contracts/RABT/infra/RabbityieldOracle/RabbityieldOracle.sol";
import { RabbityieldOracleChainlink } from "../../../contracts/RABT/infra/RabbityieldOracle/RabbityieldOracleChainlink.sol";
import { RabbityieldOracleUniswapV3 } from "../../../contracts/RABT/infra/RabbityieldOracle/RabbityieldOracleUniswapV3.sol";
import { RabbityieldOracleUniswapV2 } from "../../../contracts/RABT/infra/RabbityieldOracle/RabbityieldOracleUniswapV2.sol";
import { RabbityieldOracleSolidly } from "../../../contracts/RABT/infra/RabbityieldOracle/RabbityieldOracleSolidly.sol";
import { RabbityieldOracleErrors } from "../../../contracts/RABT/infra/RabbityieldOracle/RabbityieldOracleErrors.sol";

contract Oracle is Test {

    RabbityieldOracle public oracle;
    ...
    function setUp() public {
        oracle = new RabbityieldOracle();
        oracle.initialize();
    }

    function testSetChainlinkOracle() external {
        address chainlinkOracle = deployCode("RabbityieldOracleChainlink.sol");
    ...
    function testSetUniswapV3Oracle() external {
        ...
        address uniswapV3Oracle = deployCode("RabbityieldOracleUniswapV3.sol");
    ...
    function testSetUniswapV2Oracle() external {
        ...
        address uniswapV2Oracle = deployCode("RabbityieldOracleUniswapV2.sol");
    ...
    function testSetSolidlyOracle() external {
        ...
        address solidlyOracle = deployCode("RabbityieldOracleSolidly.sol");
    ...
    function testSetOracleNoBasePrice() external {
        ...
        address uniswapV3Oracle = deployCode("RabbityieldOracleUniswapV3.sol");
        vm.expectRevert(abi.encodeWithSelector(RabbityieldOracleErrors.NoBasePrice.selector, usdc));
        oracle.setOracle(eth, uniswapV3Oracle, usdcEthUniswapV3Feed);
    }
