...
contract AddressBookTest is Test {
    ...
    function test_RabbityieldPlatformConfig_ethereum() external {
        AddressBook.RabbityieldPlatform memory config = ab.getRabbityieldPlatformConfig("ethereum");
    ...
    function test_RabbityieldPlatformConfig_bsc() external {
        AddressBook.RabbityieldPlatform memory config = ab.getRabbityieldPlatformConfig("bsc");
