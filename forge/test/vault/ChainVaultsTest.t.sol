...
contract ChainVaultsTest is Test {
    ...
    // address book data
    AddressBook.RabbityieldPlatform addressBookRabbityield;
    ...
    function setUp() public {
        ...
        addressBookRabbityield = ab.getRabbityieldPlatformConfig(chain);
    }
...
//        assertGt(callRewards, 0, "Expected callRewards > 0");
    ...
    function test_panic() external {
        ...
        vm.prank(addressBookRabbityield.keeper);
        strategy.panic();
    ...
    function test_correctOwnerAndKeeper() external view {
        assertEq(vault.owner(), addressBookRabbityield.vaultOwner, "Wrong vault owner.");
        assertEq(strategy.owner(), addressBookRabbityield.strategyOwner, "Wrong strategy owner.");
        assertEq(strategy.keeper(), addressBookRabbityield.keeper, "Wrong keeper.");
    }
