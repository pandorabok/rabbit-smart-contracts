...
import "../../../contracts/RABT/interfaces/common/IERC20Extended.sol";
import "../../../contracts/RABT/interfaces/rabbityield/IStrategyFactory.sol";
import "../../../contracts/RABT/vaults/RabbityieldVaultV7.sol";
import "../../../contracts/RABT/strategies/Common/StratFeeManagerInitializable.sol";
    ...
    function setUp() public {
        ...
        if (vaultAddress != address(0)) {
            ...
            if (initData.length > 0) {
                RabbityieldVaultV7 vaultV7 = new RabbityieldVaultV7();
